...
Гейты **G1 ✅ G2 ✅ G3 ✅**. Ключевые задачи T-001…T-034 и T-041 сделаны.
Оставшаяся работа фазы 4 — Telegram-алертинг (T-035), ужесточение публичного
демо (T-036), бенчмарки (T-037), сайт-презентация (T-039) и релиз v1.0
(T-040 / G4) — в работе, с остатком из живых/железо-зависимых шагов. Что осознанно вне скоупа
