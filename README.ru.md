...
|---|---|---|
| **Диалоговый UI** | Чат-интерфейс с живым нарратором («ищу в интернете…»), анимированный таймлайн плана/шагов, markdown-ответ, сводка стоимости/токенов, тёмная/светлая тема и EN/RU. | [живое демо](https://ledgerlens.space/app/) |
...
| **Веб-поиск с тирами доверия** | Когда компании или цифры нет в корпусе, агент ищет в вебе, помечает доверие к каждому источнику и кэширует найденные факты, чтобы следующий прогон отвечал из БД. | [живое демо](https://ledgerlens.space/app/) |
