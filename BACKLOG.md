...
| T-030 | Eval в CI (пороги, baseline, отчёты) | 3 | T-029 | M | [wip]¹⁹ |
...
| T-041 | RAG-groundedness: синтез не должен дополнять retrieved-контекст | 3 | T-029 | M | [ ] |
