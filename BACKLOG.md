...
| T-002 | Актуализация [OPEN]-решений (ресёрч) | 0 | T-001 | M | [ ] |
| T-003 | Конфигурация и секреты | 0 | T-001 | S | [ ] |
| T-004 | Логирование и шина трейс-событий | 0 | T-003 | S | [ ] |
| T-005 | Postgres, миграции v1, клиент БД | 0 | T-003 | M | [ ] |
| T-006 | CI-скелет (GitHub Actions) | 0 | T-001 | S | [ ] |
| T-007 | Доменные модели и интерфейс адаптера | 1. Срез | T-003 | S | [ ] |
| T-008 | EDGAR: HTTP-клиент (rate-limit, кэш) | 1 | T-007 | M | [ ] |
| T-009 | EDGAR: XBRL-факты и нормализация метрик | 1 | T-008 | L | [ ] |
| T-010 | EDGAR: нарративные разделы 10-K | 1 | T-008 | L | [ ] |
| T-011 | Ingestion CLI (идемпотентный) | 1 | T-005, T-009, T-010 | M | [ ] |
...
| T-016 | Model Router (tiered + fallback + стоимость) | 2. MVP | T-002, T-004 | L | [ ] |
...
| T-023 | AG-UI эндпоинт | 2 | T-020 | M | [ ] |
...
¹ T-001: пункт «создать приватный репозиторий на GitHub» отложен до `gh auth login` владельца (Q-14) — выполняется первым же действием после авторизации, вместе с push.
