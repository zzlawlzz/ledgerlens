...
- [~] При достижении дневного капа новые раны отклоняются, система жива (тест с искусственно низким капом).²⁷ Grafana-панель по счётчику отказов — не добавлена (остаток §1).
